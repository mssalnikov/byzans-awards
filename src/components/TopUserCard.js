...
const overrides = {
	"text": {
		...
		"props": {
			"sm-display": "flex",
			"sm-font": "normal normal 500 30px/1 --fontFamily-googleMontserrat",
			"sm-width": "auto",
			"sm-height": "auto",
			"sm-justify-content": "center",
			"sm-color": "--white",
			...
			"md-font": "normal normal 500 35px/1 --fontFamily-googleMontserrat",
	...
	"text1": {
		...
		"props": {
			"color": "--white",
			"font": "normal normal 500 40px --fontFamily-googleMontserrat",
			"text-align": "center",
			"sm-font": "normal normal 500 20px --fontFamily-googleMontserrat",
			"word-wrap": "wrap",
			"children": "User Name"
		}
	},
